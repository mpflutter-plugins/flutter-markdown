...
class MarkdownBuilder implements md.NodeVisitor {
    ...
    if (_isBlockTag(tag)) {
      ...
      if (_isListTag(tag)) {
        ...
        if (_listIndents.isNotEmpty) {
          ...
          double? bulletWidth;
          final listIndent = styleSheet.listIndent;
          if (listIndent != null) {
            bulletWidth = listIndent;
          }

          final listBulletPadding = styleSheet.listBulletPadding;
          if (listBulletPadding != null) {
            if (bulletWidth == null) {
              bulletWidth = 0.0;
            }
            bulletWidth += listBulletPadding.left;
            bulletWidth += listBulletPadding.right;
          }
  ...
  Widget _buildRichText(TextSpan? text, {TextAlign? textAlign}) {
    final maxLines = styleSheet.pMaxLines;
